<template>
  <!-- Caedproduct desktop -->
  <div class="flex justify-center gap-3 mt-[5px] px-[20px] drop-shadow-lg">
    <div
      class="flex flex-col justify-between w-[200px] h-[270px] object-fill rounded-[20px] bg-white"
    >
      <div class="p-1">
        <!-- HeaderCard -->
      ...
      >
        <h1
          class="text-center h-[20px] textmain font-bold text-[7px] truncate p-2 w-[200px]"
        >
          {{ product.name }}
        </h1>
        <div
        ...
        <div class="pl-3">
          <span class="textmain font-bold text-[22px]">{{
            product.amount
          }}</span>
