<template>
  <div class="defaultpages">
      ...
      >
        ...
        >
          <div class="flex justify-between w-full">
            <h1 class="text-xl font-bold w-full flex justify-center pl-[150px]">
              การขายแต่ละประเภท
            </h1>
            <div class="w-[160px] flex justify-end">
              <div
                class="dropshadowbox w-[120px] absolute top-[220px] right-[50px]"
              >
        ...
        <div v-else class="flex justify-center items-center  w-[50%] ">
          <svg
            aria-hidden="true"
    ...
    <div v-else class="absolute top-[500px] left-[1000px]  ">
          <svg
            aria-hidden="true"
            class="w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
            viewBox="0 0 100 101"
