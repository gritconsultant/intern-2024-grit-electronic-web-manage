<template>
  <div class="defaultpages p-8 space-y-6">
    ...
    >
      ...
      >
        <h1 class="text-xl font-bold mb-2">การขายแต่ละประเภท</h1>
        <GarphPieChart :salesData="salesData" v-if="isSalesDataLoaded" />
      </div>
    </div>
...
import type { Dashboard, DashBoardCategory } from "~/models/report.model";
